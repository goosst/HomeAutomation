...
# check if an alarm is set through hassalarm
...
# download state of trigger flag
try:
...
# set a flag to indicate a new alarm is set / getting active; this is not the best piece of logic
